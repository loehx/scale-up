...
describe("util", () => {
  test.each([
    ...
    ".oneHot(%p, %p, %p, $p)",
    (value, range, ignoreOverflow, arraySize, expected) => {
      expect(
        util.oneHot(value, range, ignoreOverflow, arraySize)
  ...
  test.each([
    ...
    [2, , "2ms"],
    [
      Date.parse("2000-01-01T00:00:00"),
      Date.parse("2000-01-01T00:00:01"),
      "1s",
    ],
    [
      Date.parse("2000-01-01T00:00:00"),
      Date.parse("2000-01-01T00:01:00"),
      "1m",
    ],
    [
      Date.parse("2000-01-01T00:00:00"),
      Date.parse("2000-01-01T00:01:01"),
      "1m",
    ],
    [
      Date.parse("2000-01-01T00:00:00"),
      Date.parse("2000-01-01T01:01:01"),
      "1h",
    ],
    [
      Date.parse("2000-01-01T00:00:00"),
      Date.parse("2000-01-02T01:01:01"),
      "1d",
    ],
    [
      Date.parse("2000-01-01T00:00:00"),
      Date.parse("2000-01-08T01:01:01"),
      "7d",
    ],
    [
      Date.parse("2000-01-01T00:00:00"),
      Date.parse("2000-02-08T01:01:01"),
      "38d",
    ],
    [
      Date.parse("2000-01-01T00:00:00"),
      Date.parse("2001-02-08T01:01:01"),
      "1y",
    ],
